...
const aboutpage = () => {
    return (
        <Layout>
             ...
             <p> Sometimes I enjoy pulling pranks (harmless fun ones), going to parties, visiting new places. I'm an introvert so I prefer to hangout with a small group of friends or read a book at home after brewing a cup of tea.</p>
             ...
             <p></p>
             <p>If you wanna know more or just want to talk don't hesitate to <Link to="/contact"> send a message.</Link> </p>
